                        ...
                        <form method="post" action="{{ route('transection.store') }}">
                            ...
                            <div class="row p-2 d-flex justify-content-between">
                                ...
                                <div class="form-group col-md-4 p-1">
                                    ...
                                    <input class="form-control" name="payment" id="payment" list="browsers" placeholder="Payments">
                            ...
                            <div class="row p-2">
                                ...
                                <div class="card-body col-md-2 m-2 text-center">
...
<script>
    ...
    document.getElementById('toggleSelect').addEventListener('click', function () {
        var select = document.getElementById('existingData');
        var label = document.getElementById('existingDataLabel');

        // Toggle the visibility of the select dropdown and label
