...
<!--**********************************
        ...
        ***********************************-->
        ...
        <div class="container-fluid">
            <h4 class="card-title p-3">Visa Application Status</h4>
            <div class="table-responsive">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-3"><a class="btn btn-primary" href="{{route('visa-status.create')}}" role="button">Visa Status Add</a></h6>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger delete-btn" href="{{ route('visa-status.destroy',$status -> id ) }}">Delete</i></a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
