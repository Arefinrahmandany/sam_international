...
$(document).ready( function () {
    var table = $('#dataTable').DataTable({
        ...
        "order": [[0, 'desc']]  // Default sorting column and order (change as needed)
    });
});


//Script for Rows Per Page Change
...
$(document).ready( function () {
    ...
    // Listen for changes in the "Show" dropdown
